...
function checkIfGameWon() {
  if (wordStatus === answer) {
    document.getElementById('keyboard').innerHTML = 'አሸንፈዋል!!!';
  }
}

function checkIfGameLost() {
  if (mistakes === maxWrong) {
    document.getElementById('wordSpotlight').innerHTML = `መልሱ: ${answer} ነበር`;
    document.getElementById('keyboard').innerHTML = 'ተሸንፈዋል!!!';
  }
}
